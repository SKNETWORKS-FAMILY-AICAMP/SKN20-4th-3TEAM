"""
Django settings for dogchat_project project.
...
SECRET_KEY = 'django-insecure-v4d-a98u-0cruw&go*$5kl(+2cm9ys)&xn-9d1%bxspp$nm6*t'
...
ROOT_URLCONF = 'dogchat_project.urls'
...
WSGI_APPLICATION = 'dogchat_project.wsgi.application'
